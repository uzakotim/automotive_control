...
%% Select Car Configs 
LoadCarConfigs; %change parameters in this file
car = Porsche928; 
clear Fabia BMW Porsche928 Porsche911 HalfStable RCcar

%% Select Pacejka Config
LoadPacejkaConfigurations; %change parameters in this file
...
%% Param to simulator (don't chage here anything)
...
%% stuff for model in function (bus creation)
